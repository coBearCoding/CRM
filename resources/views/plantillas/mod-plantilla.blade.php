            ...
            <div class="collapse navbar-collapse">
                <ul class="nav" id="menu-layoutit">
                    <li>
                        ...
                        <div class="btn-group">
                             <a class="btn" style="background-color:#3f6ad8; color:#fff"  onClick="Guardar();" ><i class="ti-pencil"></i> Modificar</a>
                        </div>
                    </li>
                </ul>
            </div><!--/.navbar-collapse -->
 ...
 <a class="link"><img  border="0"  align="left" src="http://revistacomunicaccion.com/images/Actualidad/MAILING.jpg"  style="display: block;margin: 0px;max-width: 340px"></a>                                                                    </td>
  ...
  <a class="link"><img src="https://webescuela.com/wp-content/uploads/2018/05/que-es-mailing.png" alt="" style="display: block;" height="154" align="2" border="0" width="255"></a>                                                                                    </td>
            ...
            <div class="row" id="campoform">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control" name="titulo_plantilla" id="titulo_plantilla" placeholder="Ingrese El Nombres nombre para guardar su plantilla" value="<?php echo $plantilla[0]['nombre']; ?>" required>
            ...
            <div class="row" id="campoform">
                ...
                <div class="col-lg-10">
                    ...
                    <select id="cmb_campana" name="cmb_campana" class="form-control">
                        ...
                        @if($plantilla[0]->campana->id== $value->id)
            ...
            <div id="tosave" data-id=""  data-paramone="11" data-paramtwo="22" data-paramthree="33">
               <?php echo $plantilla[0]['cont_plantilla'] ?>
            </div>
        ...
        <form method="post" action="" name="ftienda">
            <input name="proceso" id="proceso" type="hidden">
            <input name="nombre" id="nombre" type="hidden">
            <input name="campana" id="campana" type="hidden">
            <input name="codigo"id="codigo" type="hidden" value="{{$plantilla[0]['id']}}">
            <input name="contenido_expo" id="contenido_expo" type="hidden">
            <textarea name="contenido" id="contenido" class="hidden" style="display: none;"></textarea>
        </form>
    </body>
    <script>
        function crear_temp(){
