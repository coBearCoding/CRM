...
@section('title')
    <div class="page-title-heading">
        ...
        <div>Configuración
            <div class="page-title-subheading">Sedes
            </div>
        </div>
    </div>
    ...
    <div class="page-title-actions">
        <div class="d-inline-block dropdown">
            <button type="button" style="display:none" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
