    ...
    <tr>
        ...
        <td class="text-center">
            ...
            <div class="btn-group">
                ...
                <button onclick="eliminar({{$res->id}},'{{$res->nombre}}')" data-id="{{$res->id}}" data-name="{{$res->nom_medio_gestion}}" type="button" class="btn btn-danger btn_delete"><i class="fas fa-trash"></i></button>
            </div>
        </td>
    </tr>
    @endforeach
