...
<head>
  ...
  })(window,document,'script','dataLayer','GTM-KGKCNMS');</script>
...
<body >
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KGKCNMS"
            ...
            <div class="bg-animation">
                <div class="d-flex h-100 justify-content-center align-items-center">
                    <div class="mx-auto app-login-box col-md-8" >
                        ...
                        <div  align="center" style="background: url('{{ asset('images/gracias_07.png') }}')  center no-repeat;  height: 500px; background-size:auto 100%;"   >
                        ...
                        <div class="text-center text-white opacity-8 mt-3">Copyright © Links  2020</div>
                    </div>
                </div>
            </div>
        </div>
