...
@section('js')
    <script src="{{ asset('../js/nprimario.js') }}"></script>
...
@section('title')
    <div class="page-title-heading">
        ...
        <div>Configuración
            <div class="page-title-subheading">{{session('nivel1')}}
            </div>
        </div>
    </div>
@endsection
