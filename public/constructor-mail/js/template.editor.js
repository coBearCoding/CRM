            ...
            self.bind('click', function () {
                ...
                switch (t) {
                    ...
                    case 'social-links':
                        ...
                        $('#social-links').show();
                         storeRedes(self.find('a.facebook').attr('href'), self.find('a.linkedin').attr('href'), self.find('a.twitter').attr('href'), self.find('a.youtube').attr('href'))
...
function storeRedes(face, linkedin, twt, youtube ) {
    if(face =='#'){face='';}
    ...
    $('input:text[name=facebook]').val(face);

    $('input:text[name=twitter]').val(twt);
    $('input:text[name=youtube]').val(youtube);

    $('input:text[name=linkedin]').val(linkedin);
}
		 ...
		 if(confirm('Estas Seguro de Eliminar?')){
          //conta elem con lyrow
              if($('#tosave .lyrow').length>3){
                ...
                $(this).parent().remove();
                showElements();
              }else alert('No puedes eliminar todos los elementos');
        }
	 })
